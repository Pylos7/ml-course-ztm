...
Before we get into the experimentation side of things, it's worth having a little reminder of what overfitting and underfitting are.
...
Great performance on the training data but poor performance on test data means your model doesn’t generalize well. Your model may be overfitting the training data. Try using a simpler model or ensuring that your test data is of the same style as your model is training on.
